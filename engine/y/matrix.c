                                                 ...
                                                 uint32_t ***data)
{
    ...
    g_assert_cmpint (matrix_get_u32_size(submatrix_size), <=, vmatrix_get_u32_size (full_matrix_size));
...
SCM_DEFINE (G_matrix_get_width, "matrix-get-height", 1, 0, 0, (SCM matrix_size), "\
...
SCM_DEFINE (G_matrix_get_width, "matrix-get-u32-size", 1, 0, 0, (SCM matrix_size), "\
...
SCM_DEFINE (G_matrix_to_bytevector, "submatrix->list-of-bytevectors", 2, 0, 0,
