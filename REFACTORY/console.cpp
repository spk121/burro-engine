...
void *
get_glyph (int glyph_set, int codepoint,
...
console_render_to_cairo_surface ()
{
    ...
    for (int r = 0; r < height; r++)
    {
        for (int c = 0; c < width; c++)
        {
            ...
            glyph_bitmap = (uint8_t *) get_glyph (0,
                                                  codepoint,
...
DEFINE_VOID_FUNC_VOID(ConsoleBell, console_bell)
DEFINE_VOID_FUNC_INT(ConsoleDeleteLeft, console_delete_left)
DEFINE_VOID_FUNC_INT(ConsoleDeleteLineDown, console_delete_line_down)
DEFINE_VOID_FUNC_INT(ConsoleDeleteLineUp, console_delete_line_up)
DEFINE_VOID_FUNC_INT(ConsoleDeleteRight, console_delete_right)
DEFINE_VOID_FUNC_INT(ConsoleEraseLeft, console_erase_left)
DEFINE_VOID_FUNC_VOID(ConsoleEraseLine, console_erase_line)
DEFINE_VOID_FUNC_VOID(ConsoleErasePage, console_erase_page)
DEFINE_VOID_FUNC_INT(ConsoleEraseRight, console_erase_right)
DEFINE_VOID_FUNC_VOID(ConsoleEraseToBeginningOfLine, console_erase_to_beginning_of_line)
DEFINE_VOID_FUNC_VOID(ConsoleEraseToBeginningOfPage, console_erase_to_beginning_of_page)
DEFINE_VOID_FUNC_VOID(ConsoleEraseToEndOfLine, console_erase_to_end_of_line)
DEFINE_VOID_FUNC_VOID(ConsoleEraseToEndOfPage, console_erase_to_end_of_page)
DEFINE_VOID_FUNC_INT(ConsoleInsertLeft, console_insert_left)
DEFINE_VOID_FUNC_INT(ConsoleInsertLineDown, console_insert_line_down)
DEFINE_VOID_FUNC_INT(ConsoleInsertLineUp, console_insert_line_up)
DEFINE_VOID_FUNC_INT(ConsoleInsertRight, console_insert_right)
DEFINE_VOID_FUNC_INT(ConsoleMoveDown, console_move_down)
DEFINE_VOID_FUNC_INT(ConsoleMoveLeft, console_move_left)
DEFINE_VOID_FUNC_INT(ConsoleMoveRight, console_move_right)
DEFINE_VOID_FUNC_INT(ConsoleMoveTabLeft, console_move_tab_left)
DEFINE_VOID_FUNC_INT(ConsoleMoveTabRight, console_move_tab_right)
DEFINE_VOID_FUNC_INTx2(ConsoleMoveTo, console_move_to)
DEFINE_VOID_FUNC_INT(ConsoleMoveToColumn, console_move_to_column)
DEFINE_VOID_FUNC_INT(ConsoleMoveToRow, console_move_to_row)
DEFINE_VOID_FUNC_INT(ConsoleMoveUp, console_move_up)
DEFINE_VOID_FUNC_INT(ConsoleMoveVerticalTabDown, console_move_vertical_tab_down)
DEFINE_VOID_FUNC_INT(ConsoleMoveVerticalTabUp, console_move_vertical_tab_up)
DEFINE_VOID_FUNC_VOID(ConsoleReset, console_reset)
DEFINE_VOID_FUNC_INT(ConsoleScrollDown, console_scroll_down)
DEFINE_VOID_FUNC_INT(ConsoleScrollUp, console_scroll_up)
DEFINE_VOID_FUNC_INT(ConsoleScrollLeft, console_scroll_left)
DEFINE_VOID_FUNC_INT(ConsoleScrollRight, console_scroll_right)
DEFINE_VOID_FUNC_UINT32(ConsoleSetBgcolor, console_set_bgcolor)
// DEFINE_VOID_FUNC_INT(ConsoleSetCursorVisibility, console_set_cursor_visibility)
DEFINE_VOID_FUNC_UINT32(ConsoleSetFgcolor, console_set_fgcolor)
DEFINE_VOID_FUNC_UINT32(ConsoleSetIntensity, console_set_intensity)
DEFINE_VOID_FUNC_UINT32(ConsoleSetPolarity, console_set_polarity)
DEFINE_VOID_FUNC_UINT32(ConsoleSetUnderline, console_set_underline)

JSBool
ConsoleWriteUtf8String(JSContext *cx, unsigned argc, jsval *vp)
{
    jsval* argv = JS_ARGV(cx, vp);
    int id;
    JSString *jstr = NULL;

    if(!JS_ConvertArguments(cx, argc, argv, "iS", &id, &jstr))
       return JS_FALSE;

    if (jstr) {
        char *str;
        str = JS_EncodeString(cx, jstr);
        console_write_utf8_string(str);
        free(str);
    }
...
JSFunctionSpec console_functions[40] = {
DECLARE_VOID_FUNC_VOID(ConsoleBell, console_bell)
DECLARE_VOID_FUNC_INT(ConsoleDeleteLeft, console_delete_left)
DECLARE_VOID_FUNC_INT(ConsoleDeleteLineDown, console_delete_line_down)
DECLARE_VOID_FUNC_INT(ConsoleDeleteLineUp, console_delete_line_up)
DECLARE_VOID_FUNC_INT(ConsoleDeleteRight, console_delete_right)
DECLARE_VOID_FUNC_INT(ConsoleEraseLeft, console_erase_left)
DECLARE_VOID_FUNC_VOID(ConsoleEraseLine, console_erase_line)
DECLARE_VOID_FUNC_VOID(ConsoleErasePage, console_erase_page)
DECLARE_VOID_FUNC_INT(ConsoleEraseRight, console_erase_right)
DECLARE_VOID_FUNC_VOID(ConsoleEraseToBeginningOfLine, console_erase_to_beginning_of_line)
DECLARE_VOID_FUNC_VOID(ConsoleEraseToBeginningOfPage, console_erase_to_beginning_of_page)
DECLARE_VOID_FUNC_VOID(ConsoleEraseToEndOfLine, console_erase_to_end_of_line)
DECLARE_VOID_FUNC_VOID(ConsoleEraseToEndOfPage, console_erase_to_end_of_page)
DECLARE_VOID_FUNC_INT(ConsoleInsertLeft, console_insert_left)
DECLARE_VOID_FUNC_INT(ConsoleInsertLineDown, console_insert_line_down)
DECLARE_VOID_FUNC_INT(ConsoleInsertLineUp, console_insert_line_up)
DECLARE_VOID_FUNC_INT(ConsoleInsertRight, console_insert_right)
DECLARE_VOID_FUNC_INT(ConsoleMoveDown, console_move_down)
DECLARE_VOID_FUNC_INT(ConsoleMoveLeft, console_move_left)
DECLARE_VOID_FUNC_INT(ConsoleMoveRight, console_move_right)
DECLARE_VOID_FUNC_INT(ConsoleMoveTabLeft, console_move_tab_left)
DECLARE_VOID_FUNC_INT(ConsoleMoveTabRight, console_move_tab_right)
DECLARE_VOID_FUNC_INTx2(ConsoleMoveTo, console_move_to)
DECLARE_VOID_FUNC_INT(ConsoleMoveToColumn, console_move_to_column)
DECLARE_VOID_FUNC_INT(ConsoleMoveToRow, console_move_to_row)
DECLARE_VOID_FUNC_INT(ConsoleMoveUp, console_move_up)
DECLARE_VOID_FUNC_INT(ConsoleMoveVerticalTabDown, console_move_vertical_tab_down)
DECLARE_VOID_FUNC_INT(ConsoleMoveVerticalTabUp, console_move_vertical_tab_up)
DECLARE_VOID_FUNC_VOID(ConsoleReset, console_reset)
DECLARE_VOID_FUNC_INT(ConsoleScrollDown, console_scroll_down)
DECLARE_VOID_FUNC_INT(ConsoleScrollUp, console_scroll_up)
DECLARE_VOID_FUNC_INT(ConsoleScrollLeft, console_scroll_left)
DECLARE_VOID_FUNC_INT(ConsoleScrollRight, console_scroll_right)
DECLARE_VOID_FUNC_UINT32(ConsoleSetBgcolor, console_set_bgcolor)
// DECLARE_VOID_FUNC_BOOL(ConsoleSetCursorVisibility, console_set_cursor_visibility)
DECLARE_VOID_FUNC_UINT32(ConsoleSetFgcolor, console_set_fgcolor)
DECLARE_VOID_FUNC_UINT32(ConsoleSetIntensity, console_set_intensity)
DECLARE_VOID_FUNC_UINT32(ConsoleSetPolarity, console_set_polarity)
DECLARE_VOID_FUNC_UINT32(ConsoleSetUnderline, console_set_underline)
JS_FS("ConsoleWriteUtf8String", ConsoleWriteUtf8String, 1, 0),
JS_FS_END
};
